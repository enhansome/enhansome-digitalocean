# Awesome DigitalOcean with stars
...
* [DigitalOcean in Action!](https://github.com/keinohguchi/do-in-action) ⭐ 11 | 🐛 0 | 🌐 HCL | 📅 2018-06-05 - Example repo for using DigitalOcean with Terraform and Ansible.
...
* [Netbox](https://github.com/digitalocean/netbox) ⭐ 21,304 | 🐛 212 | 🌐 Python | 📅 2026-08-12
* [Doctl](https://github.com/digitalocean/doctl) ⭐ 3,448 | 🐛 156 | 🌐 Go | 📅 2026-08-12 - Official command-line interface for the DigitalOcean API.
* [go-libvirt](https://github.com/digitalocean/go-libvirt) ⭐ 1,098 | 🐛 16 | 🌐 Go | 📅 2026-06-09
...
* [lita-digitalocean](https://github.com/jimmycuadra/lita-digitalocean) ⭐ 25 | 🐛 1 | 🌐 Ruby | 📅 2014-10-23 - Lita handler for managing DigitalOcean services.
* [hostpool](https://github.com/progrium/hostpool) ⭐ 22 | 🐛 0 | 🌐 Go | 📅 2013-11-08 - Worker pool manager for DigitalOcean hosts.
* [do-upgrade-plans](https://github.com/bjornjohansen/do-upgrade-plans) ⚠️ Archived - A script to upgrade your DigitalOcean Droplets to better plans with the same cost.
* [DigitalOcean Droplet creator](https://github.com/NicholasPCole/dodc) ⭐ 3 | 🐛 3 | 🌐 Shell | 📅 2020-05-13 - A dialog-based shell script to quickly create a single DigitalOcean Droplet.
* [drophosts](https://github.com/qmx/drophosts) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2016-11-29 - Update `/etc/hosts` with peer droplets.

## Clients

* [doctl](https://github.com/digitalocean/doctl) ⭐ 3,448 | 🐛 156 | 🌐 Go | 📅 2026-08-12 - Command-line tool for DigitalOcean services.
...
* [User Scripts](https://github.com/digitalocean/do_user_scripts) ⚠️ Archived - User data scripts to help provision apps on a Droplet.
* [Engineering Code of Conduct](https://github.com/digitalocean/engineering-code-of-conduct) ⭐ 296 | 🐛 3 | 📅 2023-04-02
